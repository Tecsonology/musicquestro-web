    ...
    <>
        {
            ...
            <div className='fpage flex fdc aic jc-c' style={{backgroundColor: 'black', position: 'fixed', zIndex: '3', color: 'black'}}>
                ...
                <img width={100} src={logo} alt="" />
                {
                    !showAgreement ? 
                    <div>
                        <p style={{textAlign: 'center', color: 'black'}}>MusicQuestro is currently in its beta version and undergoing pilot testing. During this 
                    ...
                    <p style={{textAlign: 'center', cursor: 'pointer', textDecoration: 'underline', color: 'black'}} onClick={()=> setShowAgreement(true)}>View User Agreement</p>
                    ...
                    <div>
                        {
                            showAgreement ? 
                            <div>
                                <h3>MusicQuestro User Agreement and Parental Consent</h3>
                                <p style={{overflowY: 'auto', height: '20em', backgroundColor: 'whitesmoke', color: 'black  '}}>
                                

                                Welcome to MusicQuestro! Our mission is to provide children with a fun, safe, and educational music experience. Because our app is designed for youth, we require both users and parents/guardians to review and agree to the following terms:

                                <span><br /><br /></span>
                                Safe and Respectful Use<span><br /></span>
                                ...
                                <span><br /><br /></span>
                                Educational Purpose<span><br /></span>
                                ...
                                <span><br /><br /></span>
                                Privacy and Safety<span><br /></span>
                                ...
                                <span><br /><br /></span>
                                Agreement to Terms<span><br /></span>
                            ...
                            <p style={{textAlign: 'center', cursor: 'pointer', textDecoration: 'underline', color: 'black'}} onClick={()=> setShowAgreement(false)}>Hide User Agreement</p>
